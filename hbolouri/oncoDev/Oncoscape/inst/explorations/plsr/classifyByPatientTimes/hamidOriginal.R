nano<-read.delim("NormalizedData_LGM_BTC_Samples_Filtered_4-9-14.txt",
	sep="\t",header=TRUE,as.is=TRUE)
probeList<-read.delim("NanoString_probeRegistry.txt",sep="\t",
...
setwd("Z:/HollandLabShared/HOPP/NanoString_tested/BTC_Pipeline_3-20-14/PatientData")
CDEs<-read.delim("BTC_PatientData_All_4-4-14.txt",
